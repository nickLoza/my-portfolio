...
function Main() {
	return (
	<main className='ml-[150px] md:ml-[300px] bg-[#25242B] py-8 px-4 xl:px-[50px] text-[#ccc]'>
      ...
      {projectsDB.map((project) => (
        <div key={project.id} className="flex flex-col justify-between sm:h-[320px] lg:h-[350px]">
          ...
          <div className="flex justify-between">
            <a href={project.websiteLink} target="_blank" rel="noopener noreferrer" className="text-white font-bold py-1 px-3 transition-color ease-in-out duration-300 bg-[#B58956] hover:bg-white hover:text-[#B58956]">Website</a>
            <a href={project.repositoryLink} target="_blank" rel="noopener noreferrer" className="text-white font-bold py-1 px-3 transition-color ease-in-out duration-300 bg-[#B58956] hover:bg-white hover:text-[#B58956]">Repository</a>
          </div>
        </div>
      ))}
    </div>
